                            ...
                            <div class="box-body table-responsive">
                                ...
                                <table class="table table-hover">
                                    <tr>
                                        ...
                                        <th style="text-align: center">@lang('site.client_name')</th>
                                        <th style="text-align: center;">@lang('site.price')</th>
                                        {{--                                        <th>@lang('site.status')</th>--}}
                                        <th style="text-align: center;">@lang('site.created_at')</th>
                                    ...
                                    @foreach ($orders as $index=>$order)
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;text-align: center">{{ $order->client->name }}</td>
                                            <td style="vertical-align: middle;text-align: center;">{{ number_format($order->total_price, 2) }}</td>
